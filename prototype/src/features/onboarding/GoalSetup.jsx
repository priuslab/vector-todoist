...
export function GoalSetup({ screenId, onBack, onNext, onRoute }) {
  ...
  return (
    ...
    >
      ...
      {screenId === "goal-test-result" ? <section className="goal-test-result-content"><div className="section-heading"><span className="success-chip">Рекомендація AI</span><h1>Твоя опорна мета</h1><p>Вона достатньо конкретна, вимірювана й відповідає тому, що зараз важливо.</p></div><div className="goal-result"><strong>{DEMO_GOAL.title}</strong><span>Висока відповідність · 92%</span></div></section> : null}
