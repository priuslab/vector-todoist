...
export function SettingsScreens({ screenId = "settings-home", onNavigate = () => {} }) {
  ...
  if (screenId === "settings-telegram") return <AppFrame title="Telegram" onBack={() => onNavigate("settings-home")} noNav footer={<Button variant="danger">Відключити Telegram</Button>}><IntegrationRow type="telegram" /><section className="integration-detail"><h1>Telegram підключено</h1><p>Голосові думки, ранковий план, нагадування та результати перепланування приходять у бот.</p><label className="switch-row"><span>Приймати голосові</span><input type="checkbox" defaultChecked /></label><label className="switch-row"><span>Кнопка Undo у повідомленнях</span><input type="checkbox" defaultChecked /></label></section></AppFrame>;
